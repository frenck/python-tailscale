...
[**Report a vulnerability**](https://github.com/frenck/python-tailscale/security/advisories/new)
...
- Issues in the Tailscale service itself; please report those directly to
  [Tailscale](https://tailscale.com/security).
- Denial-of-service or data-exposure conditions resulting from malformed or
  hostile responses from a Tailscale API endpoint the client is explicitly
  pointed at. This library assumes the configured endpoint is trusted.

## Scope

This security policy covers the `tailscale` Python package published on
[PyPI](https://pypi.org/project/tailscale/) and its source code in this
repository.

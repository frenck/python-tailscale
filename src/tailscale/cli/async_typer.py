"""Async-capable Typer wrapper used by the Tailscale CLI.
...
class AsyncTyper(SyncTyper):
    ...
    def callback(  # type: ignore[override] # ty: ignore[invalid-method-override]
        self,
        *,
    ...
    def command(  # type: ignore[override] # ty: ignore[invalid-method-override]
        self,
        name: str | None = None,
        *,
